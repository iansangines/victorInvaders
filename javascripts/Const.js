...
SI.Sizes = {
	...
	SI.Sizes.playerShipWidth = 70 * SI.Sizes.modifier;
	SI.Sizes.playerShipHeight = 70 * SI.Sizes.modifier;
	...
	SI.Sizes.enemyrocketHeight = 25 * SI.Sizes.modifier;
	SI.Sizes.enemyrocketWidth = 20 * SI.Sizes.modifier;
	SI.Sizes.enmyrocketStep = 20 * SI.Sizes.modifier;
...
SI.Images.enemyRocketImg = new Image();
SI.Images.enemyRocketImg.src = 'images/beerRocket.png';
